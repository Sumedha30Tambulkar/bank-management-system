...
public class AccountControllerTest {
    ...
    private String jwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJzaGlraGEuc2hhcm1hQGV4YW1wbGUuY29tIiwiZXhwIjoxNzQ2NDc3MDc4fQ.8UrwSOXu6EjwOKQE8GI3xAdB_eXNaAQuTy5qCYRjkkA";
    ...
    public void testCreateAccount() throws Exception {
        ...
        // Perform the request with hardcoded JWT token in Authorization header and check the response
